...
> Groups groupsCreate(createGroupsPayload)
...
let createGroupsPayload = new EchaloasuerteJsSdk.CreateGroupsPayload(); // CreateGroupsPayload | 
apiInstance.groupsCreate(createGroupsPayload).then((data) => {
...
------------- | ------------- | ------------- | -------------
 **createGroupsPayload** | [**CreateGroupsPayload**](CreateGroupsPayload.md)|  | 
