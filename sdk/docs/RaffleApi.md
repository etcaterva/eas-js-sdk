...
> Raffle raffleCreate(createRafflePayload)
...
let createRafflePayload = new EchaloasuerteJsSdk.CreateRafflePayload(); // CreateRafflePayload | 
apiInstance.raffleCreate(createRafflePayload).then((data) => {
...
------------- | ------------- | ------------- | -------------
 **createRafflePayload** | [**CreateRafflePayload**](CreateRafflePayload.md)|  | 
