...
Finally, switch to the directory you want to use your echaloasuerte-js-sdk from, and run:

```shell
npm link /path/to/<JAVASCRIPT_CLIENT_DIR>
```

You should now be able to `require('echaloasuerte-js-sdk')` in javascript files from the directory you ran the last 
command above from.
