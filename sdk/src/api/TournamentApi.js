...
export default class TournamentApi {
    ...
    */
    ...
    /**
     * @param {module:model/CreateTournamentPayload} createTournamentPayload 
     ...
     */
    tournamentCreateWithHttpInfo(createTournamentPayload) {
      let postBody = createTournamentPayload;
      // verify the required parameter 'createTournamentPayload' is set
      if (createTournamentPayload === undefined || createTournamentPayload === null) {
        throw new Error("Missing the required parameter 'createTournamentPayload' when calling tournamentCreate");
      }
     ...
     */
    tournamentCreate(createTournamentPayload) {
      return this.tournamentCreateWithHttpInfo(createTournamentPayload)
