...
export default class SpinnerApi {
    ...
    */
     ...
     */
    spinnerCreateWithHttpInfo(spinner) {
     ...
     */
    spinnerTossWithHttpInfo(id, drawTossPayload) {
     ...
     */
    spinnerToss(id, drawTossPayload) {
