...
export default class LinkApi {
    ...
    */
    ...
    /**
     * @param {module:model/CreateLinkPayload} createLinkPayload 
     ...
     */
    linkCreateWithHttpInfo(createLinkPayload) {
      let postBody = createLinkPayload;
      // verify the required parameter 'createLinkPayload' is set
      if (createLinkPayload === undefined || createLinkPayload === null) {
        throw new Error("Missing the required parameter 'createLinkPayload' when calling linkCreate");
      }
     ...
     */
    linkCreate(createLinkPayload) {
      return this.linkCreateWithHttpInfo(createLinkPayload)
