...
export default class LetterApi {
    ...
    */
    ...
    /**
     * @param {module:model/CreateLetterPayload} createLetterPayload 
     ...
     */
    letterCreateWithHttpInfo(createLetterPayload) {
      let postBody = createLetterPayload;
      // verify the required parameter 'createLetterPayload' is set
      if (createLetterPayload === undefined || createLetterPayload === null) {
        throw new Error("Missing the required parameter 'createLetterPayload' when calling letterCreate");
      }
     ...
     */
    letterCreate(createLetterPayload) {
      return this.letterCreateWithHttpInfo(createLetterPayload)
