...
export default class LotteryApi {
    ...
    */
    ...
    /**
     * @param {module:model/CreateLotteryPayload} createLotteryPayload 
     ...
     */
    lotteryCreateWithHttpInfo(createLotteryPayload) {
      let postBody = createLotteryPayload;
      // verify the required parameter 'createLotteryPayload' is set
      if (createLotteryPayload === undefined || createLotteryPayload === null) {
        throw new Error("Missing the required parameter 'createLotteryPayload' when calling lotteryCreate");
      }
     ...
     */
    lotteryCreate(createLotteryPayload) {
      return this.lotteryCreateWithHttpInfo(createLotteryPayload)
