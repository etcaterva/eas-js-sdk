...
export default class RandomNumberApi {
    ...
    */
    ...
    /**
     * @param {module:model/CreateRandomNumberPayload} createRandomNumberPayload 
     ...
     */
    randomNumberCreateWithHttpInfo(createRandomNumberPayload) {
      let postBody = createRandomNumberPayload;
      // verify the required parameter 'createRandomNumberPayload' is set
      if (createRandomNumberPayload === undefined || createRandomNumberPayload === null) {
        throw new Error("Missing the required parameter 'createRandomNumberPayload' when calling randomNumberCreate");
      }
     ...
     */
    randomNumberCreate(createRandomNumberPayload) {
      return this.randomNumberCreateWithHttpInfo(createRandomNumberPayload)
