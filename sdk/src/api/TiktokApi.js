...
export default class TiktokApi {
    ...
    */
    ...
    /**
     * @param {module:model/Tiktok} tiktok 
     ...
     */
    tiktokCreateWithHttpInfo(tiktok) {
      let postBody = tiktok;
      // verify the required parameter 'tiktok' is set
      if (tiktok === undefined || tiktok === null) {
        throw new Error("Missing the required parameter 'tiktok' when calling tiktokCreate");
      }
     ...
     */
    tiktokCreate(tiktok) {
      return this.tiktokCreateWithHttpInfo(tiktok)
