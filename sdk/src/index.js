...
* <pre>
* var @EtcatervaEasJsSdk = require('index'); // See note below*.
* var xxxSvc = new @EtcatervaEasJsSdk.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new @EtcatervaEasJsSdk.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new @EtcatervaEasJsSdk.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new @EtcatervaEasJsSdk.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
