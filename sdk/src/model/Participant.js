...
class Participant {
     ...
     * @implements module:model/ParticipantField
     * @param id {String} 
     * @param createdAt {Date} 
     * @param name {String} 
     */
    constructor(id, createdAt, name) { 
        BaseObject.initialize(this, id, createdAt);ParticipantField.initialize(this, name);
        Participant.initialize(this, id, createdAt, name);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            ParticipantField.constructFromObject(data, obj);
...
Participant.RequiredProperties = ["id", "created_at", "name"];
...
// Implement ParticipantField interface:
/**
 * @member {String} name
 */
