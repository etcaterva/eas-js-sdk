...
class Prize {
     ...
     * @implements module:model/PrizeField
     * @param id {String} 
     * @param createdAt {Date} 
     * @param name {String} 
     */
    constructor(id, createdAt, name) { 
        BaseObject.initialize(this, id, createdAt);PrizeField.initialize(this, name);
        Prize.initialize(this, id, createdAt, name);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            PrizeField.constructFromObject(data, obj);
...
Prize.RequiredProperties = ["id", "created_at", "name"];
...
// Implement PrizeField interface:
/**
 * @member {String} name
 */
