...
class Lottery {
     ...
     * @param payments {Array.<module:model/Lottery.PaymentsEnum>} 
     * @param participants {Array.<module:model/ParticipantField>} 
     * @param results {Array.<module:model/LotteryResult>} 
     */
    constructor(id, createdAt, title, description, payments, participants, results) { 
        BaseDraw.initialize(this, id, createdAt, title, description, payments);LotteryFields.initialize(this, participants);
        Lottery.initialize(this, id, createdAt, title, description, payments, participants, results);
    }
...
Lottery.RequiredProperties = ["id", "created_at", "title", "description", "payments", "participants", "results"];
