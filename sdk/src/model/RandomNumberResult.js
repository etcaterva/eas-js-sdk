...
class RandomNumberResult {
    ...
    constructor(scheduleDate, createdAt) { 
        ...
        RandomNumberResult.initialize(this, scheduleDate, createdAt);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of RandomNumberResult.RequiredProperties) {
...
RandomNumberResult.RequiredProperties = ["schedule_date", "created_at"];
