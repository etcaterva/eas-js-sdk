...
import TournamentResultAllOfValue from './TournamentResultAllOfValue';
...
class TournamentResult {
    ...
    constructor(scheduleDate, createdAt) { 
        ...
        TournamentResult.initialize(this, scheduleDate, createdAt);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('value')) {
                obj['value'] = ApiClient.convertToType(data['value'], [TournamentResultAllOfValue]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TournamentResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TournamentResult</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TournamentResult.RequiredProperties) {
        ...
        if (data['value']) { // data not null
            ...
            for (const item of data['value']) {
                TournamentResultAllOfValue.validateJSON(item);
            };
        }
...
TournamentResult.RequiredProperties = ["schedule_date", "created_at"];
...
/**
 * @member {Array.<module:model/TournamentResultAllOfValue>} value
 */
