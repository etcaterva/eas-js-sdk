...
class LetterResult {
    ...
    constructor(scheduleDate, createdAt) { 
        ...
        LetterResult.initialize(this, scheduleDate, createdAt);
    }
    ...
    /**
     * Validates the JSON data with respect to <code>LetterResult</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>LetterResult</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of LetterResult.RequiredProperties) {
...
LetterResult.RequiredProperties = ["schedule_date", "created_at"];
