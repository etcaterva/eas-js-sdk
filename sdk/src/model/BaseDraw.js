...
class BaseDraw {
     ...
     * @implements module:model/BaseFields
     * @param id {String} 
     * @param createdAt {Date} 
     * @param title {String} 
     * @param description {String} 
     * @param payments {Array.<module:model/BaseDraw.PaymentsEnum>} 
     */
    constructor(id, createdAt, title, description, payments) { 
        BaseObject.initialize(this, id, createdAt);BaseFields.initialize(this, title, description, payments);
        BaseDraw.initialize(this, id, createdAt, title, description, payments);
    }
     ...
     */
    static initialize(obj, id, createdAt, title, description, payments) { 
        obj['id'] = id;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            BaseFields.constructFromObject(data, obj);
    ...
    static validateJSON(data) {
        ...
        for (const property of BaseDraw.RequiredProperties) {
...
BaseDraw.RequiredProperties = ["id", "created_at", "title", "description", "payments"];
...
// Implement BaseFields interface:
/**
 * @member {String} title
 */
