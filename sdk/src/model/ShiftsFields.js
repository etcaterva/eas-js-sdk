...
/**
 * The ShiftsFields model module.
 * @module model/ShiftsFields
 * @version 1.0.0
 */
class ShiftsFields {
    /**
     * Constructs a new <code>ShiftsFields</code>.
     * @alias module:model/ShiftsFields
    ...
    constructor(intervals, participants) { 
        ...
        ShiftsFields.initialize(this, intervals, participants);
    }
    ...
    /**
     * Constructs a <code>ShiftsFields</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ShiftsFields} obj Optional instance to populate.
     * @return {module:model/ShiftsFields} The populated <code>ShiftsFields</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ShiftsFields();
    ...
    /**
     * Validates the JSON data with respect to <code>ShiftsFields</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ShiftsFields</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ShiftsFields.RequiredProperties) {
...
ShiftsFields.RequiredProperties = ["intervals", "participants"];
