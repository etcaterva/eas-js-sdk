...
class Spinner {
     ...
     * @param payments {Array.<module:model/Spinner.PaymentsEnum>} 
     */
    constructor(id, createdAt, title, description, payments) { 
        BaseDraw.initialize(this, id, createdAt, title, description, payments);
        Spinner.initialize(this, id, createdAt, title, description, payments);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of Spinner.RequiredProperties) {
...
Spinner.RequiredProperties = ["id", "created_at", "title", "description", "payments"];
