...
class DrawReTossPayload {
     ...
     * @param prizeId {String} 
     */
    constructor(prizeId) { 
        
        DrawReTossPayload.initialize(this, prizeId);
    }
     ...
     */
    static initialize(obj, prizeId) { 
        obj['prize_id'] = prizeId;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of DrawReTossPayload.RequiredProperties) {
...
DrawReTossPayload.RequiredProperties = ["prize_id"];
