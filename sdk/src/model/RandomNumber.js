...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BaseDraw', 'model/DrawMetadata', 'model/RandomNumberResult'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./BaseDraw'), require('./DrawMetadata'), require('./RandomNumberResult'));
  } else {
    // Browser globals (root is window)
    if (!root.EchaloasuerteJsSdk) {
      root.EchaloasuerteJsSdk = {};
    }
    root.EchaloasuerteJsSdk.RandomNumber = factory(root.EchaloasuerteJsSdk.ApiClient, root.EchaloasuerteJsSdk.BaseDraw, root.EchaloasuerteJsSdk.DrawMetadata, root.EchaloasuerteJsSdk.RandomNumberResult);
  }
}(this, function(ApiClient, BaseDraw, DrawMetadata, RandomNumberResult) {
  'use strict';
   ...
   * @param rangeMax {} 
   */
  var exports = function(rangeMin, rangeMax) {
    var _this = this;
    BaseDraw.call(_this);
    BaseDraw.call(_this);
    _this['range_min'] = rangeMin;
    _this['range_max'] = rangeMax;
   ...
   */
  exports.prototype['range_min'] = undefined;
  /**
   * @member {Number} range_max
   */
  exports.prototype['range_max'] = undefined;
  /**
