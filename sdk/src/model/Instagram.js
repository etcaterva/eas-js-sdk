...
class Instagram {
     ...
     * @param payments {Array.<module:model/Instagram.PaymentsEnum>} 
     * @param prizes {Array.<module:model/PrizeField>} 
     * @param useLikes {Boolean} 
     * @param minMentions {Number} 
     * @param postUrl {String} 
     * @param results {Array.<module:model/InstagramResult>} 
     */
    constructor(id, createdAt, title, description, payments, prizes, useLikes, minMentions, postUrl, results) { 
        BaseDraw.initialize(this, id, createdAt, title, description, payments);InstagramFields.initialize(this, prizes, useLikes, minMentions, postUrl);
        Instagram.initialize(this, id, createdAt, title, description, payments, prizes, useLikes, minMentions, postUrl, results);
    }
     ...
     */
    static initialize(obj, id, createdAt, title, description, payments, prizes, useLikes, minMentions, postUrl, results) { 
        obj['id'] = id;
...
Instagram.RequiredProperties = ["id", "created_at", "title", "description", "payments", "prizes", "use_likes", "min_mentions", "post_url", "results"];
