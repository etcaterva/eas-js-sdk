...
class Raffle {
     ...
     * @param payments {Array.<module:model/Raffle.PaymentsEnum>} 
     * @param prizes {Array.<module:model/PrizeField>} 
     * @param participants {Array.<module:model/ParticipantField>} 
     * @param results {Array.<module:model/RaffleResult>} 
     */
    constructor(id, createdAt, title, description, payments, prizes, participants, results) { 
        BaseDraw.initialize(this, id, createdAt, title, description, payments);RaffleFields.initialize(this, prizes, participants);
        Raffle.initialize(this, id, createdAt, title, description, payments, prizes, participants, results);
    }
     ...
     */
    static initialize(obj, id, createdAt, title, description, payments, prizes, participants, results) { 
        obj['id'] = id;
...
Raffle.RequiredProperties = ["id", "created_at", "title", "description", "payments", "prizes", "participants", "results"];
