...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EchaloasuerteJsSdk.LinkFields();
  });
  ...
  describe('LinkFields', function() {
    it('should create an instance of LinkFields', function() {
      // uncomment below and update the code to test LinkFields
      //var instance = new EchaloasuerteJsSdk.LinkFields();
      //expect(instance).to.be.a(EchaloasuerteJsSdk.LinkFields);
    });
