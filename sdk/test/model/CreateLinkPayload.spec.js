...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EchaloasuerteJsSdk.CreateLinkPayload();
  });
  ...
  describe('CreateLinkPayload', function() {
    it('should create an instance of CreateLinkPayload', function() {
      // uncomment below and update the code to test CreateLinkPayload
      //var instance = new EchaloasuerteJsSdk.CreateLinkPayload();
      //expect(instance).to.be.a(EchaloasuerteJsSdk.CreateLinkPayload);
    });
