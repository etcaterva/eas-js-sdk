...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EchaloasuerteJsSdk.CreateLetterPayload();
  });
  ...
  describe('CreateLetterPayload', function() {
    it('should create an instance of CreateLetterPayload', function() {
      // uncomment below and update the code to test CreateLetterPayload
      //var instance = new EchaloasuerteJsSdk.CreateLetterPayload();
      //expect(instance).to.be.a(EchaloasuerteJsSdk.CreateLetterPayload);
    });
