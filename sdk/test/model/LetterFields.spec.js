...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EchaloasuerteJsSdk.LetterFields();
  });
  ...
  describe('LetterFields', function() {
    it('should create an instance of LetterFields', function() {
      // uncomment below and update the code to test LetterFields
      //var instance = new EchaloasuerteJsSdk.LetterFields();
      //expect(instance).to.be.a(EchaloasuerteJsSdk.LetterFields);
    });
