...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EchaloasuerteJsSdk.CreateRandomNumberPayload();
  });
  ...
  describe('CreateRandomNumberPayload', function() {
    it('should create an instance of CreateRandomNumberPayload', function() {
      // uncomment below and update the code to test CreateRandomNumberPayload
      //var instance = new EchaloasuerteJsSdk.CreateRandomNumberPayload();
      //expect(instance).to.be.a(EchaloasuerteJsSdk.CreateRandomNumberPayload);
    });
