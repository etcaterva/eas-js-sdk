...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EchaloasuerteJsSdk.CreateRafflePayload();
  });
  ...
  describe('CreateRafflePayload', function() {
    it('should create an instance of CreateRafflePayload', function() {
      // uncomment below and update the code to test CreateRafflePayload
      //var instance = new EchaloasuerteJsSdk.CreateRafflePayload();
      //expect(instance).to.be.a(EchaloasuerteJsSdk.CreateRafflePayload);
    });
