...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EchaloasuerteJsSdk.ShiftsFields();
  });
  ...
  describe('ShiftsFields', function() {
    it('should create an instance of ShiftsFields', function() {
      // uncomment below and update the code to test ShiftsFields
      //var instance = new EchaloasuerteJsSdk.ShiftsFields();
      //expect(instance).to.be.a(EchaloasuerteJsSdk.ShiftsFields);
    });
