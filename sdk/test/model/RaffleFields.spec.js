...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EchaloasuerteJsSdk.RaffleFields();
  });
  ...
  describe('RaffleFields', function() {
    it('should create an instance of RaffleFields', function() {
      // uncomment below and update the code to test RaffleFields
      //var instance = new EchaloasuerteJsSdk.RaffleFields();
      //expect(instance).to.be.a(EchaloasuerteJsSdk.RaffleFields);
    });
