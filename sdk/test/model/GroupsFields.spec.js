...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EchaloasuerteJsSdk.GroupsFields();
  });
  ...
  describe('GroupsFields', function() {
    it('should create an instance of GroupsFields', function() {
      // uncomment below and update the code to test GroupsFields
      //var instance = new EchaloasuerteJsSdk.GroupsFields();
      //expect(instance).to.be.a(EchaloasuerteJsSdk.GroupsFields);
    });
