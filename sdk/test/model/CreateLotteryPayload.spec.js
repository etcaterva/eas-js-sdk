...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EchaloasuerteJsSdk.CreateLotteryPayload();
  });
  ...
  describe('CreateLotteryPayload', function() {
    it('should create an instance of CreateLotteryPayload', function() {
      // uncomment below and update the code to test CreateLotteryPayload
      //var instance = new EchaloasuerteJsSdk.CreateLotteryPayload();
      //expect(instance).to.be.a(EchaloasuerteJsSdk.CreateLotteryPayload);
    });
