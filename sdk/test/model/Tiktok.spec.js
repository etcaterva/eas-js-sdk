...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EchaloasuerteJsSdk.Tiktok();
  });
  ...
  describe('Tiktok', function() {
    it('should create an instance of Tiktok', function() {
      // uncomment below and update the code to test Tiktok
      //var instance = new EchaloasuerteJsSdk.Tiktok();
      //expect(instance).to.be.a(EchaloasuerteJsSdk.Tiktok);
    });
