...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EchaloasuerteJsSdk.CreateTiktokPayload();
  });
  ...
  describe('CreateTiktokPayload', function() {
    it('should create an instance of CreateTiktokPayload', function() {
      // uncomment below and update the code to test CreateTiktokPayload
      //var instance = new EchaloasuerteJsSdk.CreateTiktokPayload();
      //expect(instance).to.be.a(EchaloasuerteJsSdk.CreateTiktokPayload);
    });
