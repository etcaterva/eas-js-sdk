...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EchaloasuerteJsSdk.CreateShiftsPayload();
  });
  ...
  describe('CreateShiftsPayload', function() {
    it('should create an instance of CreateShiftsPayload', function() {
      // uncomment below and update the code to test CreateShiftsPayload
      //var instance = new EchaloasuerteJsSdk.CreateShiftsPayload();
      //expect(instance).to.be.a(EchaloasuerteJsSdk.CreateShiftsPayload);
    });
