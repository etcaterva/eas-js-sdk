...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EchaloasuerteJsSdk.CreateGroupsPayload();
  });
  ...
  describe('CreateGroupsPayload', function() {
    it('should create an instance of CreateGroupsPayload', function() {
      // uncomment below and update the code to test CreateGroupsPayload
      //var instance = new EchaloasuerteJsSdk.CreateGroupsPayload();
      //expect(instance).to.be.a(EchaloasuerteJsSdk.CreateGroupsPayload);
    });
