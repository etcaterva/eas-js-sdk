...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EchaloasuerteJsSdk.TiktokFields();
  });
  ...
  describe('TiktokFields', function() {
    it('should create an instance of TiktokFields', function() {
      // uncomment below and update the code to test TiktokFields
      //var instance = new EchaloasuerteJsSdk.TiktokFields();
      //expect(instance).to.be.a(EchaloasuerteJsSdk.TiktokFields);
    });
