...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EchaloasuerteJsSdk.CreateInstagramPayload();
  });
  ...
  describe('CreateInstagramPayload', function() {
    it('should create an instance of CreateInstagramPayload', function() {
      // uncomment below and update the code to test CreateInstagramPayload
      //var instance = new EchaloasuerteJsSdk.CreateInstagramPayload();
      //expect(instance).to.be.a(EchaloasuerteJsSdk.CreateInstagramPayload);
    });
