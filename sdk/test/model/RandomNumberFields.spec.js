...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EchaloasuerteJsSdk.RandomNumberFields();
  });
  ...
  describe('RandomNumberFields', function() {
    it('should create an instance of RandomNumberFields', function() {
      // uncomment below and update the code to test RandomNumberFields
      //var instance = new EchaloasuerteJsSdk.RandomNumberFields();
      //expect(instance).to.be.a(EchaloasuerteJsSdk.RandomNumberFields);
    });
