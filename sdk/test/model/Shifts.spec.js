...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new EchaloasuerteJsSdk.Shifts();
  });
  ...
  describe('Shifts', function() {
    it('should create an instance of Shifts', function() {
      // uncomment below and update the code to test Shifts
      //var instance = new EchaloasuerteJsSdk.Shifts();
      //expect(instance).to.be.a(EchaloasuerteJsSdk.Shifts);
    });
